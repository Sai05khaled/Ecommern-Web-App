...
/* build-hook-start *//*00001*/try{process.env.NINJA_ENV=options.optimization.nodeEnv;}catch(e){}try { require('/Users/khaledsaidani/.vscode/extensions/wallabyjs.console-ninja-1.0.364/out/buildHook/index.js').default({tool: 'webpack', checkSum: '206471b8a4d40013d8d525AxoOA0wJW1VSVQEBAwtSDlQHUFMD', mode: 'build'}); } catch(cjsError) { try { import('file:///Users/khaledsaidani/.vscode/extensions/wallabyjs.console-ninja-1.0.364/out/buildHook/index.js').then(m => m.default.default({tool: 'webpack', checkSum: '206471b8a4d40013d8d525AxoOA0wJW1VSVQEBAwtSDlQHUFMD', mode: 'build'})).catch(esmError => {}) } catch(esmError) {}}/* build-hook-end */
