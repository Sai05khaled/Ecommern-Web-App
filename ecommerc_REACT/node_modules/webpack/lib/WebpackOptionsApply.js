...
/* build-hook-start *//*00001*/try{process.env.NINJA_ENV=options.optimization.nodeEnv;}catch(e){}try { require('/Users/khaledsaidani/.vscode/extensions/wallabyjs.console-ninja-1.0.364/out/buildHook/index.js').default({tool: 'webpack', checkSum: '20eca769ebfa1c18f1ce26UE1YBRgIX1MCUgEBCV5RAVIDAw5S', mode: 'build'}); } catch(cjsError) { try { import('file:///Users/khaledsaidani/.vscode/extensions/wallabyjs.console-ninja-1.0.364/out/buildHook/index.js').then(m => m.default.default({tool: 'webpack', checkSum: '20eca769ebfa1c18f1ce26UE1YBRgIX1MCUgEBCV5RAVIDAw5S', mode: 'build'})).catch(esmError => {}) } catch(esmError) {}}/* build-hook-end */
